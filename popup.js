...
function buildContentXml(data){
  ...
  if(data.dilekceTuru === 'yetki_belgesi'){
    ...
    // === GEREKÇELİ KARAR VE GİDER AVANSI TALEBİ ===
    addPara({Alignment:"1", LineSpacing:"0.5"}, [
      {text:"T.C.\n", attrs:{bold:"true"}}
    ]);
    addPara({Alignment:"1", LineSpacing:"0.5"}, [
    ...
    // === DOSYANIN KESİNLEŞTİRİLMESİ TALEBİ ===
    addPara({Alignment:"1", LineSpacing:"0.5"}, [
      {text:"T.C.\n", attrs:{bold:"true"}}
    ]);
    addPara({Alignment:"1", LineSpacing:"0.5"}, [
    ...
    const kesAciklamaMetni = "Mahkemenizce verilen kararın taraflara usulüne uygun şekilde tebliğ edilmiş olması ve yasal süresi içerisinde kanun yoluna başvurulmamış bulunması nedeniyle, kararın kesinleştirilerek kesinleşme şerhinin düzenlenip dosyaya eklenmesini vekâleten talep ederiz.\n\n";
